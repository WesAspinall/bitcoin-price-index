...
var _currencyList = require('./currencyList');

var _currencyList2 = _interopRequireDefault(_currencyList);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var currency = (0, _currencyList2.default)();

var URL = 'https://api.coindesk.com/v1/bpi/currentprice.json';
var priceIndex = document.querySelector('.price-index');
...
select.innerHTML = currency.map(function (item) {
...
select.onchange = function () {
  ...
  fetch('https://api.coindesk.com/v1/bpi/currentprice/' + this.value + '.json\n').then(function (res) {
    ...
    var foo = data.bpi;
    var bar = Object.values(foo);
    console.log(bar[1].rate);
  });
};

},{"./currencyList":3,"jquery":1}],3:[function(require,module,exports){
"use strict";
...
exports.default = getCurrencyList;
